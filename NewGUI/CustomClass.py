        ...
        for i in range(len(raw)):
            ...
            try:
                ...
                if(self.Normalize_cb.isChecked()):
                    ...
                    self.axes.set_xlabel(self.items[a]+" Norm by "+standardnamechosen)
                    self.x_element_label.setText(self.items[a]+" Norm by "+standardnamechosen)

                    self.axes.set_ylabel(self.items[b]+" Norm by "+standardnamechosen)
                    self.y_element_label.setText(self.items[b]+" Norm by "+standardnamechosen)
    ...
    def Magic(self):
        ...
        for i in range(len(raw)):
            ...
            try:
                ...
                TPoints.append(TriPoint((xuse,yuse,zuse), Size=raw.at[i, 'Size'],Color=raw.at[i, 'Color'], Alpha=raw.at[i, 'Alpha'], Marker=raw.at[i, 'Marker'],Label=TmpLabel))
