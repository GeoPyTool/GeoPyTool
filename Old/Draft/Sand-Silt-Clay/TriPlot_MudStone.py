...
A  triangular diagram with Sand/Silt/Clay
"""
...
class TriPlot(Unit.Tri,Unit.Tool):
    ...
    def __init__(self, name="MudStone.xlsx",Label=[u'Clay', u'Sand', u'Silt']):
        super().__init__()
    ...
    def read(self):
        ...
        for i in range(len(raw)):
            ...
            Unit.TriPoint((raw.at[i, 'sand'], raw.at[i, 'silt'], raw.at[i, 'clay']), Size=raw.at[i, 'Size'],
