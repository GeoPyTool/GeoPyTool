...
class Tas(Frame):
    ...
    def __init__(self, name="tas.xlsx", Width=16, Height=9, Dpi=80, Left=35, Right=79, X0=30, X1=90, X_Gap=7, Base=0,
        ...
        self.Lines = [
            Line([(41, 0), (41, 3), (45, 3)], Sort='', Width=1, Color='black', Style="-", Alpha=0.3),
            Line([(45, 0), (45, 3), (45, 5), (49.4, 7.3), (53, 9.3), (57.6, 11.7), (61, 13.5), (63, 16.2)], Sort='',
                 Width=1,
                 Color='black', Style="-", Alpha=0.3),
            Line([(52, 5), (57, 5.9), (63, 7), (69, 8), (71.8, 13.5), (61, 8.6)], Sort='', Width=1, Color='black',
                 Style="-",
                 Alpha=0.3),
            ...
            Line(
                [(69, 8), (77.3, 0), (87.5, 4.7), (85.9, 6.8), (71.8, 13.5), (63, 16.2), (57, 18), (52.5, 18), (37, 14),
                 (35, 9), (37, 3), (41, 3)], Sort='', Width=1, Color='black', Style="-", Alpha=0.3),
...
class Polar(Frame):
    ...
    def read(self):
        ...
        self.schmidt()
        self.multirose()
        self.singlerose(Name=['Dip', 'Strike'], Color=['red', 'green'])
    ...
    def __init__(self, name="Ballard.xlsx"):
        ...
        for i in self.b:
            if i != 'Label' and i != 'Eu(II)' and i != 'Ce' and i != 'Ce(+4)':
                ...
                Ri = float(self.raw.at['Ri', i])
                Ro = float(self.raw.at['Ro', i])
